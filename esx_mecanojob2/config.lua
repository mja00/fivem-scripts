...
Config.Zones = {
  MecanoActions = {
    Pos   = { x = 2342.27, y = 3139.91, z = 47.21 },
  ...
  Craft = {
    Pos   = { x = 2359.95, y = 3128.12, z = 47.21 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Color = { r = 204, g = 204, b = 0 },
    Type  = 1,
  },
  ...
  VehicleSpawnPoint = {
    Pos   = { x = 2330.03, y = 3149.59, z = 47.13 },
    Size  = { x = 1.5, y = 1.5, z = 1.0 },
    Type  = -1,
  },

  VehicleDeleter = {
    Pos   = { x = 2328.83, y = 3137.83, z = 47.16 },
  ...
  VehicleDelivery = {
    Pos   = { x = 2305.22, y = 3141.13, z = 46.81 },
