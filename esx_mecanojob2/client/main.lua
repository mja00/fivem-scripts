...
function StopNPCJob(cancel)
  ...
  if cancel then
    ...
    TriggerServerEvent('esx_mecanojob2:onNPCJobCompleted')
  end
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'gaz_bottle' then
          menu.close()
          TriggerServerEvent('esx_mecanojob2:startHarvest')
        end

        if data.current.value == 'fix_tool' then
          menu.close()
          TriggerServerEvent('esx_mecanojob2:startHarvest2')
        end

        if data.current.value == 'caro_tool' then
          menu.close()
          TriggerServerEvent('esx_mecanojob2:startHarvest3')
        end
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'blow_pipe' then
          menu.close()
          TriggerServerEvent('esx_mecanojob2:startCraft')
        end

        if data.current.value == 'fix_kit' then
          menu.close()
          TriggerServerEvent('esx_mecanojob2:startCraft2')
        end

        if data.current.value == 'caro_kit' then
          menu.close()
          TriggerServerEvent('esx_mecanojob2:startCraft3')
        end
          ...
          function(data, menu)
            ...
            if amount == nil or amount < 0 then
              ...
              if closestPlayer == -1 or closestDistance > 3.0 then
				...
				menu.close()
                TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_mecano2', _U('mechanic'), amount)
              end
            end
          end,
        function(data, menu)
            ...
            if NPCOnJob then
              ...
              if NPCTargetDeleterZone then
                ...
                if CurrentlyTowedVehicle == NPCTargetTowable then
                  ...
                  TriggerServerEvent('esx_mecanojob2:onNPCJobMissionCompleted')
                  StopNPCJob()
...
RegisterNetEvent('esx_mecanojob2:onHijack')
AddEventHandler('esx_mecanojob2:onHijack', function()
  local playerPed = GetPlayerPed(-1)
  local coords    = GetEntityCoords(playerPed)
...
AddEventHandler('esx_mecanojob2:hasExitedMarker', function(zone)
  ...
  if zone == 'Craft' then
    TriggerServerEvent('esx_mecanojob2:stopCraft')
    TriggerServerEvent('esx_mecanojob2:stopCraft2')
    TriggerServerEvent('esx_mecanojob2:stopCraft3')
  end

  if zone == 'Garage' then
    TriggerServerEvent('esx_mecanojob2:stopHarvest')
    TriggerServerEvent('esx_mecanojob2:stopHarvest2')
    TriggerServerEvent('esx_mecanojob2:stopHarvest3')
  end
...
AddEventHandler('esx_mecanojob2:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job ~= nil and PlayerData.job.name == 'mecano2' and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  while true do
    Wait(0)
    if PlayerData.job ~= nil and PlayerData.job.name == 'mecano2' then
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('esx_mecanojob2:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('esx_mecanojob2:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
...
Citizen.CreateThread(function()
    while true do
        ...
        if CurrentAction ~= nil then
          ...
          if IsControlJustReleased(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'mecano2' then
        ...
        if IsControlJustReleased(0, Keys['F6']) and not IsDead and PlayerData.job ~= nil and PlayerData.job.name == 'mecano2' then
            OpenMobileMecanoActionsMenu()
        end

        if IsControlJustReleased(0, Keys['DELETE']) and not IsDead and PlayerData.job ~= nil and PlayerData.job.name == 'mecano2' then
